        ...
        <div class="container-fluid">
           ...
           @endif
            <table class="table">
                        ...
                        <tbody>
                            <form action="{{route('edit_student_editHandle',['student_id'=>$student->user_id, 'level'=> $student->level ])}}" method="post">
                                <tr>
                                    <td>First</td>
                                        <?php $num = 0;?>
                                        @foreach($firstgrade as $grade)
                                        <td><input type="text" name="{{$num = $num+1}}f" size="4" required="" value="{{$grade->grade}}"></td>
