        ...
        <div class="container-fluid">
           ...
           @endif
            <table class="table">
                        ...
                        <tbody>
                            <form action="{{route('edit_student_editHandle2',['student_id'=>$student->user_id, 'level'=> $student->level ])}}" method="post">
                                <tr>
                                    <td>Second</td>
                                        <?php $num = 0;?>
                                        @foreach($secondgrade as $grade)
                                        <td><input type="text" name="{{$num = $num+1}}s" size="4" required="" value="{{$grade->grade}}"></td>
