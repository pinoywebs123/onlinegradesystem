                            ...
                            <tr>
                                ...
                                @if($thirdgrade)
                                     <td colspan="10">
                                        <div class="">
                                           <p class="text-center">
                                            <a href="{{route('edit_student_grade3', ['student_id'=>$student->user_id, 'level'=> $student->level ])}}"><i class="pe-7s-note"></i></a>EDIT</p>
                                        </div>
                                    </td>
                                @else 
                            ...
                            <tr>
                                ...
                                @if($finalgrade)
                                     <td colspan="10">
                                        <div class="">
                                            <p class="text-center">
                                            <a href="{{route('edit_student_grade4', ['student_id'=>$student->user_id, 'level'=> $student->level ])}}"><i class="pe-7s-note"></i></a>EDIT</p>
                                        </div>
                                    </td>
                                @else 
